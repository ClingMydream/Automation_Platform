...
import { Login } from './modules/登录/登录UI/Login.jsx';
import { ApiCasePanel } from './modules/接口测试/接口测试UI/ApiCasePanel.jsx';
import { CodecPanel } from './modules/转码工具/转码工具UI/CodecPanel.jsx';
import { FileTransferPanel } from './modules/文件快传/文件快传UI/FileTransferPanel.jsx';
import { PublicTransferPage } from './modules/文件快传/文件快传UI/PublicTransferPage.jsx';
import { ImageToolPanel } from './modules/图片工具/图片工具UI/ImageToolPanel.jsx';
import { JsonToolsPanel } from './modules/JSON工具/JSON工具UI/JsonToolsPanel.jsx';
import { LiveRunWindow } from './modules/实时执行窗口/实时执行窗口UI/LiveRunWindow.jsx';
import { ProjectPanel } from './modules/项目/项目UI/ProjectPanel.jsx';
import { ReportsPanel } from './modules/测试报告/测试报告UI/ReportsPanel.jsx';
import { RunsPanel } from './modules/执行记录/执行记录UI/RunsPanel.jsx';
import { UiCasePanel } from './modules/UI测试/UI测试UI/UiCasePanel.jsx';
import { UserPanel } from './modules/用户管理/用户管理UI/UserPanel.jsx';
